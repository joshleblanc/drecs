...
clang.exe -shared .\native\ext-bind.c --sysroot=C:\mingw64 -IC:\LLVM\lib\clang\10.0.0\include -std=c99 --target=x86_64-w64-mingw32 -fuse-ld=lld -isystem %DRB_ROOT%\include -I. -o ../native\windows-amd64\ext.dll