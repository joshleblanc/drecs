...
clang -v -shared .\app\ext.c --sysroot=C:\mingw64 -std=gnu99 --target=x86_64-w64-mingw32 -fuse-ld=lld -isystem %DRB_ROOT%\include -I. -lWs2_32 -o native\windows-amd64\flecs.dll
